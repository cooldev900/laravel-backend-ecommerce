 ...
 *
 * @OA\Schema(
 * @OA\Xml(name="CheckoutCom"),
 * @OA\Property(property="id", type="integer", readOnly="true", example="1"),
 * @OA\Property(property="public_api_key", type="string", description="Merchant Id", example="sdf_sdf4_sfd2"),
 * @OA\Property(property="secret_api_key", type="string", description="CheckoutCom Key", example=""),
 ...
 * @OA\Property(property="secret_api_key_sandbox", type="string", description="CheckoutCom Key", example=""),
