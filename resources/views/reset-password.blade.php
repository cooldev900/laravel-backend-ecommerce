                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        ...
                                                                        request to reset your password on omni
                                                                        automotive.</span></p>
                                                                <p style="font-size: 14px; line-height: 140%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                                                                style="font-size: 16px; line-height: 22.4px;">This
                                                                                link will be expired in
                                                                                15min.<br />Please ignore this email if
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="{{url('/images/image-2.png')}}"
                                                                                            alt="Facebook"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Twitter"
                                                                                        target="_blank">
                                                                                        <img src="{{url('/images/image-3.png')}}"
                                                                                            alt="Twitter"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{url('/images/image-4.png')}}"
                                                                                            alt="Instagram"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="{{url('/images/image-1.png')}}"
                                                                                            alt="LinkedIn"
